...
class HassebDALIUSBDriver(DALIDriver):
    ...
    def __init__(self, path=None):
        try:
            ...
            import sys
            logging.getLogger("hasseb.py").warning("device.open error: {}".format(sys.exception()))
            self.device_found = None
        logging.getLogger("hasseb.py").warning("device_found is: {}".format(self.device_found))
